...
import type { NormalizedProcurement, MatchResult, EnrichedAlert } from '../types/procurement';
...
export async function enrichMatch(
  ...
  try {
    ...
    log.warn({ err }, 'Error obteniendo historial — continuando sin antecedentes');
  }
