export const EXTERNAL_LEADS_SCHEMA_SQL = `
...
CREATE INDEX IF NOT EXISTS idx_external_leads_detected_at ON external_leads (detected_at DESC);
CREATE INDEX IF NOT EXISTS idx_external_leads_vertical ON external_leads (vertical, estimated_interest_score DESC);
CREATE INDEX IF NOT EXISTS idx_external_leads_state ON external_leads (state);
CREATE INDEX IF NOT EXISTS idx_external_leads_status ON external_leads (status);
